...
public class LocationMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    private LocationMapViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_location_map, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        // TODO: Complete this method to show location on map
